...
data class TennisDocColorScheme(
...
val DarkSwingColors = TennisDocColorScheme(
...
val LightSwingColors = TennisDocColorScheme(
...
val LocalTennisDocColorScheme = staticCompositionLocalOf { DarkSwingColors }

object SwingTheme {
    val colors: TennisDocColorScheme
        @Composable
        @ReadOnlyComposable
        get() = LocalTennisDocColorScheme.current
}
