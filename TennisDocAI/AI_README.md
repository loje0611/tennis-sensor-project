...
- **멀티모듈**: `:app`, `:core:model`, `:core:ui`, `:core:sensor`, `:core:data`, `:core:analysis`, `:core:vision`, `:feature:match` (Match 화면 보유, v1 내비게이션 비활성), `:feature:history` (이력 화면 보유), `:feature:lab`
