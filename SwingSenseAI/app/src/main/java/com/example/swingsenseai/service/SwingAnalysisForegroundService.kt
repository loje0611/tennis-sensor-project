package com.example.swingsenseai.service
...
import com.example.swingsenseai.MainActivity
import com.example.swingsenseai.R
import com.example.swingsenseai.analysis.EdgeImpulseInputSpec
import com.example.swingsenseai.analysis.KinematicAnalyzer
import com.example.swingsenseai.analysis.RawSwingTelemetry
import com.example.swingsenseai.analysis.SwingClassificationKeys
import com.example.swingsenseai.analysis.SwingInferenceBuffer
import com.example.swingsenseai.analysis.SwingKinematicsBuffer
import com.example.swingsenseai.analysis.VolleyDetector
import kotlin.math.sqrt
import com.example.swingsenseai.sensor.ImuPayloadParser
import com.example.swingsenseai.sensor.MockBleDataSource
import com.example.swingsenseai.sensor.MockSwingDataGenerator
import com.example.swingsenseai.sensor.RealBleDataSource
import com.example.swingsenseai.sensor.SensorDataSource
import com.example.swingsenseai.session.SwingAnalysisSessionState
import com.example.swingsenseai.ui.SwingLabelFormatter
...
class SwingAnalysisForegroundService : Service() {
    ...
    private fun insertSwingEvent(
        ...
        metrics: com.example.swingsenseai.analysis.SwingMetrics,
    ...
    companion object {
        const val ACTION_START = "com.example.swingsenseai.action.START_ANALYSIS"
        const val ACTION_STOP = "com.example.swingsenseai.action.STOP_ANALYSIS"
        const val ACTION_DEBUG_SIMULATE = "com.example.swingsenseai.action.DEBUG_SIMULATE_SWING"
        const val ACTION_SEND_BLE_COMMAND = "com.example.swingsenseai.action.SEND_BLE_COMMAND"
        const val ACTION_MOCK_START = "com.example.swingsenseai.action.MOCK_START"
        const val ACTION_MOCK_STOP = "com.example.swingsenseai.action.MOCK_STOP"
        const val ACTION_MOCK_SWING = "com.example.swingsenseai.action.MOCK_SWING"
